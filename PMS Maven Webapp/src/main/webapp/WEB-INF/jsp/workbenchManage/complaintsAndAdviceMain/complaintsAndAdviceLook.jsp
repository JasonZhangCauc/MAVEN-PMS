		...
		<div class="col-md-12">
			<div class="portlet light portlet-fit bordered">
		         ...
		         <div class="portlet-body form">
					<form class="form-horizontal  form-bordered" id="complainLook" autocomplete="off" 
				    data-validator-option="{theme:'yellow_right_effect',focusCleanup:true}">
						...
						<div class="form-body">
							<div class="form-group">
				                ...
				                <div class="col-md-4 text-left">
									<select class="bs-select form-filter form-control" 
										id="advicesType" 
										name="advicesType" disabled="disabled"
										data-rule="required;" 
										data-size="10" 
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea class="form-control" readonly="readonly" rows="3" id="advicesContent" name="advicesContent"  data-rule="required;" 
...
<div class="modal-footer">
	<div class="col-md-offset-11 col-md-1">
        <button class="btn default" data-dismiss="modal" aria-hidden="true" id="closeComplainLook"><spring:message code='btn.common.close'/></button>
    </div>
</div>
<script type="text/javascript">
	var complainLookOldVal=$("#complainLook").serializeFormJson();
	//投诉建议类型下拉框
	$("#complainLook #advicesType").initDic('${vo.advicesType}',codeBasicInfo.adviceType); 
	var complainLookField = { 
		advicesType:"<spring:message code='lable.Complaints.type' />",
		advicesContent:"<spring:message code='label.msgProcess.mText' />",
	};
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/workbenchManage/complaintsAndAdviceMain/complaintsAndAdviceLook.js"></script>

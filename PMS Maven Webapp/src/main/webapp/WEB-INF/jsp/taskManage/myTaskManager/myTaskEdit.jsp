		...
		<div class="col-md-12">
			<div class="portlet light portlet-fit bordered">
		         ...
		         <div class="portlet-body form">
					<form class="form-horizontal form-bordered" id="myTaskEditFormId"
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control" rows="2" id="theme"
									data-rule="required;length[~50];" name="theme" readonly="readonly"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" name="completeDegree" id="completeDegree"  value="${vo.completeDegree}"/>
		                    </div>
						</div>
						<div class="form-group">
							<!-- 描述 -->
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control" rows="3" id="instructions"
									data-rule="length[~2000];" name="instructions"
									placeholder="<spring:message code='common.laber.noneMustInputData'/>"
						...
						<div class="form-actions">
							<div class="modal-footer">
								...
								<c:if test="${vo.status=='1' || vo.status=='0'}" >
									<button type="button" class="btn green" id="saveMyTaskId">
...
<div class="modal-footer">
	<div class="col-md-offset-11 col-md-1">
        <button class="btn default" data-dismiss="modal" aria-hidden="true" id="closeMyTaskId"><spring:message code='btn.common.close'/></button>
    </div>
</div>	
<script type="text/javascript">
	$("#myTaskEditFormId #tasktype").initDic('${vo.tasktype}',codeBasicInfo.taskType);//任务类型
	$("#myTaskEditFormId #priority").initDic('${vo.priority}',codeBasicInfo.priority);//优先级
	$("#myTaskEditFormId #status").initDic('${vo.status}',codeBasicInfo.taskStatus);//状态
	$("#myTaskEditFormId #whyType").initDic('${vo.whyType}',codeBasicInfo.whyType);//原因类型
	
	var myTaskOldVal=$("#myTaskEditFormId").serializeFormJson();
	$("#myTaskEditFormId #completeDegree").ionRangeSlider({min: 0,max:100,postfix: "%"});
	var myTaskField = {
		status:"<spring:message code='label.taskIssuedManager.status' />",
		instructions:"<spring:message code='label.taskIssuedManager.instructions' />",
		completeDegree:"<spring:message code='label.taskIssuedManager.completeDegree' />",
		actualHour:"<spring:message code='label.taskIssuedManager.actualHour' />"
	};
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/taskManage/myTaskManager/myTaskEdit.js"></script>
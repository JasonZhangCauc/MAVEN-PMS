		...
		<div class="col-md-12">
			<div class="portlet light portlet-fit bordered">
		         ...
		         <div class="portlet-body form">
					<form class="form-horizontal form-bordered" id="projectSuperviseEditFormId"
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
								   ...
								   id="requiredDate" 
								   name="requiredDate" readonly="readonly"
								   data-rule="required;"
								   data-date-format="yyyy-mm-dd"
								...
								<div class="col-md-4">
									<input type="text" 
								   class="date-picker form-control dateSelect" 
								   id="actualDate"  readonly="readonly"
								   name="actualDate"
								   data-date-format="yyyy-mm-dd"
								   value="${vo.actualDate}"/>
								</div> --%>
							...
							<div class="form-actions">
								<div class="modal-footer">
									...
									<button type="button" class="btn blue" id="saveSuperviseInfoId">
...
<div class="modal-footer">
	<div class="col-md-offset-11 col-md-1">
        <button class="btn default" data-dismiss="modal" aria-hidden="true" id="closeProjectBaseInfoEditIdEST"><spring:message code='btn.common.close'/></button>
    </div>
</div>	
<!-- 参数列表 -->
<script type="text/javascript">
	$("#projectSuperviseEditFormId #responsibilityDepartment").initDic('${vo.responsibilityDepartment}',codeBasicInfo.toDivision);
	$("#projectSuperviseEditFormId #whetherDelay").initDic('${vo.whetherDelay}',codeBasicInfo.isNot);
	 $("#projectSuperviseEditFormId #whetherAdvance").initDic('${vo.whetherAdvance}',codeBasicInfo.isNot);
	$("#projectSuperviseEditFormId #taskSource").initDic('${vo.taskSource}',codeBasicInfo.taskSource); 
	$("#projectSuperviseEditFormId #relevanceProject").initRecordProjectInfo('${vo.relevanceProject}');
	$("#projectSuperviseEditFormId #priority").initDic('${vo.priority}',codeBasicInfo.priorityonly); 
	$("#projectSuperviseEditFormId #conclusion").initDic('${vo.conclusion}',codeBasicInfo.conclusion);  
	$("#projectSuperviseEditFormId #responsibleMain").responsibleSecondary('${vo.responsibleMain}');
	$("#projectSuperviseEditFormId #responsibleSecondary").responsibleSecondary('${vo.responsibleSecondary}');
	$("#projectSuperviseEditFormId #accepter").responsibleSecondary('${vo.accepter}'); 
	var projectBaseInfoOldVal=$("#projectSuperviseEditFormId").serializeFormJson();
...
<!-- 引用配置JS -->
<script type="text/javascript"
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/taskManage/superviseWorkInfoList/superviseWorkInfoEdit.js"></script>
		             ...
		             <div class="caption">
		                 ...
		                 <span class="caption-subject font-red sbold uppercase">
			                 <font style="vertical-align: inherit;">
			                       <font style="vertical-align: inherit;"><spring:message code='lable.projectBaseinfo.projectApproval' /></font>
			                 </font>
		                 </span>
		             </div>
		             <div class="tools">
					...
					<form class="form-horizontal form-bordered" id="projectBaseInfoEditFormId"
						...
						<div class="form-body">
							<div class="form-group">
								...
								<!-- 所属事业部 -->
								<label class="control-label col-md-2"> 
									<spring:message code='lable.projectBaseinfo.toDivisionxm' /> 
								</label>
								<div class="col-md-4">
									<input type="text" 
										class="form-control" 
							...
							<div class="form-group">
								...
								<!-- 销售负责人-->
								<label class="control-label col-md-2">
								     <spring:message code='lable.saleTrack.proResponsers' />
								     <span class="required">* </span>
								</label>
								<div class="col-md-4">							
									 <select class="bs-select form-filter form-control" 								
...
<script type="text/javascript">
	var productManagerVal = '${vo.productManager}';
	$("#projectBaseInfoEditFormId #belongCustomId").initCustomerInfo('${vo.belongCustomId}');
	$("#projectBaseInfoEditFormId #saleResponsible").initUserInfoSale('${vo.saleResponsible}');
	
	$("#projectBaseInfoEditFormId #businessPeople").businessPeople('${vo.businessPeople}');
	$("#projectBaseInfoEditFormId #projectHead").projectPeople('${vo.projectHead}');  
	$("#projectBaseInfoEditFormId #productManager").productManager('${vo.productManager}');
	$("#projectBaseInfoEditFormId #projectManager").projectPeople('${vo.projectManager}');
	$("#projectBaseInfoEditFormId #belongProduct").initDic('${vo.belongProduct}',codeBasicInfo.projectonly);
...
<!-- 引用配置JS -->
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/projectManage/projectApprovalManager/projectApprovalEdit.js"></script>
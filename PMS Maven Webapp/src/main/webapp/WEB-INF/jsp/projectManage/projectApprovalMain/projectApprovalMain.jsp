	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit bordered query">
	         ...
	         <div class="portlet-body form">
             	<form class="form-horizontal" id="projectApprovalMainFormId" method="post">
			        <div class="form-body">
						...
						<div class="line_p collapse" id="projectBaseInfoHide" aria-expanded=false>
							<div class="form-group">
								...
								<!-- 工期 开始-->
				                <label class="col-md-1 control-label">
				                	<spring:message code='lable.projectBaseinfo.workTimeBegin' />:
				                </label>
				                <div class="col-md-2 text-left">
									<input type="text" 
				                ...
				                <!-- 工期 -->
				                <label class="col-md-1 control-label">
				                	<spring:message code='lable.projectBaseinfo.workTimeEnd' />:
				                </label>
				                <div class="col-md-2 text-left">
								    <input type="text" 
								    	id="endTime" 
	        ...
	        <div class="portlet light portlet-fit portlet-datatable bordered">
	            <div class="portlet-title">  
	                <div class="actions">
	                    <div class="btn-group btn-group-devided" data-toggle="buttons">
							<auth:auth resourceCode="R004_01_OPERATION_EDIT">
								<a href="<%=request.getContextPath()%>/projectManage/projectApprovalEdit?operate=add" data-target="#project-modal" 
								data-toggle="modal" class="btn btn-circle green-haze">
								<i class="fa fa-plus"></i></a>
							</auth:auth>
							<a href="<%=request.getContextPath()%>/projectManage/importExcelApproval" 
	            ...
	            <div class="portlet-body">
	                <div class="table-container">
	                    <table class="table table-striped table-bordered table-hover" id="projectApprovalMianTableId"></table>
	                </div>
	            </div>
	        </div>
	    </div>
...
<script type="text/javascript">
	...
	var projectManagerMian_projectEdit = "<spring:message code='lable.projectManager.detail' />";//项目详情
	var gridProjectBaseInfo = new Datatable();//项目维护Datatable
	var hasEditProjectBaseInfoAuth = isUserHasAuth("R004_01_OPERATION_EDIT"); //编辑权限
	var hasRemoveProjectBaseInfoAuth = isUserHasAuth("R004_01_OPERATION_DEL"); //删除权限
	var hasAuditProjectBaseInfoAuth = isUserHasAuth("R004_01_OPERATION_AUTH"); //审核权限
	$("#projectApprovalMainFormId #projectPhase").initDic(null,codeBasicInfo.projectPhase);//项目阶段
	$("#projectApprovalMainFormId #projectStatus").initDic(null,codeBasicInfo.projectState);//项目状态	
	$("#projectApprovalMainFormId #auditStatus").initDic(null,codeBasicInfo.auditStatus);//审核状态
</script>
<!-- 引用js -->
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/projectManage/projectApprovalManager/projectApprovalMain.js"></script>
...
<div class="modal-header">
    ...
    <div class="modal-body todo-task-modal-body">
        ...
        <form class="form-horizontal form-bordered" id="workhoursEditFormId" autocomplete="off" enctype="multipart/form-data"
              data-validator-option="{theme:'yellow_right_effect',focusCleanup:true}"> 
				<input type="hidden" value="${workHoursVo.id}" name="id" id="Id" />
				<input type="hidden" value="" name="changeDetails" id="changeDetails" />
				<div class="form-group">
					<!-- 操作人 -->
					<label class="control-label col-md-2">
					   <spring:message code='label.workHoursManager.createByName' />
					</label>	 
					<div class="col-md-4">
						<input type="hidden" name="createBy" value="${workHoursVo.createBy}" />
						<input type="text" 
							   class="form-control" 
							   id="createByName" 
							   readonly="readonly"
							   name="createByName"
							   value="${workHoursVo.createByName}"/>
					</div>
					<!-- 操作时间 -->
					<label class="control-label col-md-2"> 
					  <spring:message code='label.workHoursManager.createDate' />
					</label>
					<div class="col-md-4">
						<input type="text" 
						   class="form-control" 
				...
				<div class="form-group">
					<!-- 工时类型 -->
					<label class="control-label col-md-2"> <spring:message code='label.workHoursManager.workingType' />
						<span class="required">*</span>
					 </label>
					<div class="col-md-4">
						<select class="bs-select form-filter form-control" 
					...
					<!-- 工时总数 -->
					<label class="control-label col-md-2"> <spring:message code='label.workHoursManager.workingHours' />								
						<span class="required">*</span> 
					</label>
					<div class="col-md-4">
						<input type="text" 
							...
							value="${workHoursVo.workingHours}"
				...
				<div class="form-group">
					<!-- 开始日期 -->
					<label class="control-label col-md-2"> 
						<spring:message code='label.workHoursManager.beginDate' /> 
					</label>
					<div class="col-md-4">
						<input type="text" 
							...
							id="beginDate"
							name="beginDate" 
							value="${workHoursVo.beginDate}"
							placeholder="<spring:message code='message.pleaseselect'/>" />
					</div>
					<!-- 结束日期 -->
					<label class="control-label col-md-2"> 
						<spring:message code='label.workHoursManager.endDate' /> 
					</label>
					<div class="col-md-4">
						<input type="text" 
							class="form-control date-picker dateSelect" 
				...
				<div class="form-group last">
					<!-- 涉及资源 -->
					<label class="control-label col-md-2"> 
						<spring:message code='label.workHoursManager.involvingResource' /> 
					</label>
					<div class="col-md-9">
						<textarea class="form-control" rows="3" style="width: 100%;" id="involvingResource" 
							data-rule="length[~1000];"
							placeholder="<spring:message code='common.laber.noneMustInputData'/>"
							name="involvingResource" value="${workHoursVo.involvingResource}">${workHoursVo.involvingResource}</textarea>
					</div>
				</div>					
				<div class="form-actions">
                    <div class="modal-footer">
	                     <button type="button" class="btn btn-danger" id="clearWorkhoursEditId">
							  <spring:message code='btn.common.clear' />
						 </button>
	                     <button type="button" class="btn green" id="saveWorkHoursId">
    ...
    <div class="modal-footer">
      	<div class="col-md-offset-11 col-md-1">
        	<button class="btn default" data-dismiss="modal" aria-hidden="true" id="closeWorkhoursEditId"><spring:message code='btn.common.close'/></button>
     	</div>
    </div>	
<!-- 参数列表 -->
<script type="text/javascript">
	//下拉框初始化
	$("#workhoursEditFormId #projectId").initProjectInfo('${workHoursVo.projectId}');
	$("#workhoursEditFormId #workingType").initDic('${workHoursVo.workingType}',codeBasicInfo.workHoursType); 
	
	var workhoursOldVal=$("#workhoursEditFormId").serializeFormJson();
    var workhoursField = {
		createByName:"<spring:message code='label.workHoursManager.createByName' />",
		createDate:"<spring:message code='label.workHoursManager.createDate' />",
		projectId:"<spring:message code='label.workHoursManager.projectId' />",							
		workingType:"<spring:message code='label.workHoursManager.workingType' />",
 		workingHours:"<spring:message code='label.workHoursManager.workingHours' />	",							
		beginDate:"<spring:message code='label.workHoursManager.beginDate' /> ",
		endDate:"<spring:message code='label.workHoursManager.endDate' />", 
		involvingResource:"<spring:message code='label.workHoursManager.involvingResource' />" 
	};
</script>
<!-- 引用配置JS -->
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/projectManage/workhoursmanager/workHoursManagerEdit.js"></script>
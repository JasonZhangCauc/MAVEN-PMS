		...
		<div class="portlet box grey-cascade form-fit">
			...
			<div class="portlet-body form">
				<form class="form-horizontal form-bordered" id="milepostEditFormId"
					...
					<input type="hidden" value="${milepostVo.projectId}" name="projectId" id="milepostProjectId"  />
...
<script type="text/javascript">
	...
	var operation='${operate}';
	var errCountMeg="<spring:message code='lable.projectManager.errMileCountMsg' />";
	
	var milepostAddOldVal=$("#milepostEditFormId").serializeFormJson();
	var milepostAddField = {
		milepostName:"<spring:message code='lable.milepost.milepostName' />",
		planCompletedate:"<spring:message code='lable.milepost.planCompletedate' />",
		correspondingPhase:"<spring:message code='lable.milepost.correspondingPhase' />",
		milepostStatus:"<spring:message code='lable.milepost.milepostStatus' />",
		milepostDescribe:"<spring:message code='lable.milepost.milepostDescribe' />",
		remark:"<spring:message code='lable.milepost.remark' />"
	};
	//附件初始化
	var milepostEdit_operate='${operate}';
	$(function(){
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/projectManagement/projectManager/milepostManagerEdit.js"></script>

		...
		<div class="portlet box grey-cascade form-fit">
			<div class="portlet-title">
				<div class="caption">
					...
					<spring:message code='label.workHoursManager.deliverables' />
				</div>
				<div class="tools">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" 
							   ...
							   placeholder="<spring:message code='lable.deliveries.pleaseinputdeliveriesName'/>" />
						</div>
						<!-- 计划交付时间 -->
						<label class="control-label col-md-2">
...
<script type="text/javascript">
	...
	var deliveriesEditOldVal=$("#deliveriesEditFormId").serializeFormJson();
	var deliveriesEditField = {
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/projectManagement/projectMonitorManager/deliveriesManagerEdit.js"></script>

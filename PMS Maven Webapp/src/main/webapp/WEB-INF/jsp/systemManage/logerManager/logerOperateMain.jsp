			         ...
			         <div class="form-body">
				         <div class="form-group">
			                ...
			                <div class="col-md-2 input-group input-large">
							 ...
							 <div class="col-md-2">
							    <button type="button" class="btn btn-primary mt-ladda-btn ladda-button" data-style="slide-left" id="searchLogerOperateBtn">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
        	<div class="mt-element-ribbon bg-grey-steel">
	           <div class="ribbon ribbon-border-hor ribbon-clip ribbon-color-danger uppercase">
	                ...
	                <span class="caption-subject bold uppercase"><spring:message code='label.operatlog'/></span> 
		       </div>
		    </div>
            <div class="portlet-title">
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="logerOperateMianTableId"></table>
                </div>
            </div>
         </div>
    </div>
...
<script type="text/javascript">
	var o1="<spring:message code='label.operatelog.operator' />";//操作者
	var o2="<spring:message code='label.operatelog.operatetime' />";//操作时间
	var o3="<spring:message code='label.operatelog.operatecategory' />";//功能模块
	var o4="<spring:message code='label.operatelog.operatecontent' />";//操作描述
	var gridLogOperate = new Datatable();//操作日志Datatable
</script>
<!-- 引用js文件 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/systemManage/logerManager/logerOperate.js"></script>
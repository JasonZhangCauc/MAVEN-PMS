			...
			<div class="col-md-12">
				<div class="portlet light portlet-fit bordered">
			         ...
			         <div class="portlet-body form">
				          <form class="form-horizontal form-bordered" id="TrackEditFormIdLook" autocomplete="off" 
						    data-validator-option="{theme:'yellow_right_effect',focusCleanup:true}">
			                    ...
			                    <div class="form-group">                       
									...
									<div class="col-md-4">
										<input type="text" 
											   class="form-control" 
											   id="projectName"
											   name="projectName" readonly="readonly"
								...
								<div class="form-group">
									...
									<div class="col-md-4">						     
										 <select class="bs-select form-filter form-control" 
												data-size="10" 
												value="${vo.currency}" disabled="disabled"
												title="<spring:message code='message.pleaseselect' />" 
												id="currency"
												name="currency">
						                 </select>
...
<script type="text/javascript">
		$("#TrackEditFormIdLook #saleStatus").initDic('${vo.saleStatus}',codeBasicInfo.saleStatus);
		$("#TrackEditFormIdLook #currency").initDic('${vo.currency}',codeBasicInfo.btype);
		$("#TrackEditFormIdLook #belongProduct").initDic('${vo.belongProduct}',codeBasicInfo.projectonly);
		$("#TrackEditFormIdLook #customerId").initCustomerInfo('${vo.customerId}');
		$("#TrackEditFormIdLook #saleResponsible").initUserInfoSale('${vo.saleResponsible}');
		$("#TrackEditFormIdLook #createDept").val(getDeptByIds($("#TrackEditFormId #createDept").val()));
		$("#TrackEditFormIdLook #decisionMaker").initCusLinker('${vo.decisionMaker}','${vo.customerId}');
		$("#TrackEditFormIdLook #stakeholder").initCusLinker('${vo.stakeholder}','${vo.customerId}');
		$("#TrackEditFormIdLook #linker").initCusLinker('${vo.linker}','${vo.customerId}');
		...
		var saleTrackOldVal=$("#TrackEditFormIdLook").serializeFormJson();
		var saleTrackField = { 
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/preSalesManage/saletrack/saleTrackLook.js"></script>